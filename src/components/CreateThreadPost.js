            ...
            <Col>
              <Form>
                <Form.Group>
                  ...
                  <Form.Control type="text" placeholder="CS 268 Homework Help" onChange={handleTitleChange}/>
                </Form.Group>
                <Form.Group>
                  <Form.Label>Subject</Form.Label>
                  <Form.Control type="text" placeholder="Help! I'm building a React app and I have no idea what I'm doing!" onChange={handleSubjectChange}/>
                </Form.Group>
                <Form.Group>
